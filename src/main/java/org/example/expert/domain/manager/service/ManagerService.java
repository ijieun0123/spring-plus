...
public class ManagerService {
    ...
    public ManagerSaveResponse saveManager(AuthUser authUser, long todoId, ManagerSaveRequest managerSaveRequest) {
        ...
        try{
            ...
            try{
                managerLogService.save(Status.SUCCESS, null, managerSaveRequest.getManagerUserId());
            } catch(Exception logE){
                System.err.println("로그 기록 실패 ( SUCCESS 저장 중 오류 )");
            }
            ...
            try{
                managerLogService.save(Status.FAIL, e.getMessage(), managerSaveRequest.getManagerUserId());
            } catch(Exception logE){
                System.err.println("로그 기록 실패 ( FAIL 저장 중 오류 )");
            }
            throw e;
        }
    }
